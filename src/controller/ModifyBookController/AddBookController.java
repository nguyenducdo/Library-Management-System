...
public class AddBookController implements Initializable{
	...
	public void add(ActionEvent evt) {
		...
		loader.setLocation(getClass().getResource("/view/BookInformation.fxml"));
		try {
			loader.load();
		} catch (IOException e) {
		...
		if(bookInfoController== null) System.out.println("NULLLLLLLLL");
		bookInfoController.refresh(bookInfoController.getTabBooks());
		stage.close();
	}
